    ...
    <div className="mt-4">
      ...
      >
        <img
          src={images.src}
          alt={images.alt}
          className="object-cover w-11/12 m-3 mb-10 rounded-lg h-[15rem]"
        />
        <div className="flex flex-row md:flex-row sm:flex-row">
          <div className="flex flex-col justify-between p-2 leading-normal mt-1 w-full">
            ...
            <div className="inline-flex">
              <p className="mb-3 font-normal text-sm text-[#187B92] dark:text-gray-400 underline underline-offset-1">
            ...
            <div className="hide-on-filter-screens">
